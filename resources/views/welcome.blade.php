...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <!-- Success Message -->
    @if(session('success'))
    <div class="fixed top-4 right-4 z-50 bg-green-900/20 border border-green-500/30 rounded-xl p-4 max-w-md">
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC]">{{ session('success') }}</p>
            </div>
        </div>
    </div>
    @endif
