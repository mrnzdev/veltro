...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-12">
        ...
        <div class="mb-8">
            <h4 class="text-lg font-medium text-[#01FF87] mb-4">Equipos de los que soy dueño</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-[#2a2a2a] rounded-xl p-6 border border-[#3a3a3a] hover:border-[#01FF87]/50 transition-colors duration-200">
                    ...
                    <div class="flex items-center justify-between text-sm text-gray-400 mb-4">
                        <span class="truncate">{{ $team->getCurrentMembersCount() }}/{{ $team->max_members }} miembros</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-[#2a2a2a] rounded-xl p-6 border border-[#3a3a3a] hover:border-[#01FF87]/50 transition-colors duration-200">
                ...
                <div class="flex items-center justify-between text-sm text-gray-400 mb-4">
                    ...
                    <span class="truncate">Propietario: {{ $team->owner->name }}</span>
                </div>
                <div class="flex space-x-2">
                    <a href="{{ route('teams.show', $team) }}"
                        class="flex-1 text-center px-3 py-2 bg-[#3a3a3a] text-[#CDFDE6] rounded-lg hover:bg-[#4a4a4a] transition-colors duration-200">
